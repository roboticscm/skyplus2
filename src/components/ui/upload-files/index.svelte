<script lang="ts">
    ...
    const uploadFiles = (files: any) => {
        ...
        RxHttp.upload('sys/upload', formData, savePath).pipe(take(1)).subscribe((res: any) => {
...
<div class="upload-files" bind:this={uploadFilesRef} on:dragover={onDragover} on:dragleave={onDragleave} on:drop={onDrop}>
    <CloseableList bind:this={filenameRef} {menuPath} id="{id + 'UploadFileId'}" on:close={onDeleteFile}>

    </CloseableList>
    <div class="upload-files__info">
        <i class="upload-files__info__icon fa fa-cloud-upload-alt"></i>
